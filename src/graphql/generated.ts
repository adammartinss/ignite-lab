...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, lessonType: LessonType, title: string, slug: string, availableAt?: any | null, videoId: string }> };
